...
class CurrencyController extends Controller
{
    public function __construct() {
        ...
        $this->middleware("Permission:Currency_Create",['only'=>['create','store','update_values']]);
       ...
       public function index(){
        ...
        public function update_values() {
             get_convert_value();
             return redirect()->route('currency-index')->with('success',translate('Your Currencies Values Was Updated Succfully'));
        }
}
