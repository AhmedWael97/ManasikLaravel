...
Route::prefix('/Users')->group(function() {
    Route::get('/index/{term?}','App\Http\Controllers\UserController@index')->name('Users');
...
Route::prefix('/Orders')->group(function() {
    ...
    Route::get('/specificExecuter/{id}/{status}','App\Http\Controllers\OrderController@specificExecuter')->name('specificExecuter');
