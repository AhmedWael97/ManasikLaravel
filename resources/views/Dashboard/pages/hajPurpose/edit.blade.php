...
<section class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ Route('HajPurpose') }}">{{ translate('Haj Purposes') }}</a></li>
            <li class="breadcrumb-item active"> {{ translate('Edit Haj Purpose') }}</li>
        </ol>
        </div>
    </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">
                {{ translate('Edit Haj Purpose') }}
              </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="form">
                    <form method="post" action="{{ route('HajPurpose-Update') }}">
                        @csrf
